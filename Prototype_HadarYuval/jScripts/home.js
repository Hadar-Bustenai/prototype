$(document).ready(function () {
    ...
    $("#carousel1").click(function () {
        ...
        $("#topSection").css("background-image", "url(https://hadar-bustenai.github.io/prototype/Prototype_HadarYuval/images/shuka_banner.png");
    })

    $("#carousel2").click(function () {
        console.log("carousel-back-2");
        $("#topSection").css("background-image", "url(https://hadar-bustenai.github.io/prototype/Prototype_HadarYuval/images/batya_banner.png");
    })

    $("#carousel3").click(function () {
        console.log("carousel-back-3");
        $("#topSection").css("background-image", "url(https://hadar-bustenai.github.io/prototype/Prototype_HadarYuval/images/eazy_banner.png");
    })
